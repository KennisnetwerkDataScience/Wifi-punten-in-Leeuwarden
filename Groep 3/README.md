...
app_helejaar.R			Code voor het maken van de animatie van het aantal bezoekers per uur door het hele jaar heen. 
connects.py			Onderzoeks programma om te kijken wat de gemiddelde snelheid is van een device tussen de wifi punten.
				Er kwamen negatieve snelheden uit, dus wat extra code op het einde om hier iets meer over te weten te 
				komen.
				Waarschijnlijk loopt de klok op elk wifi meetpunt niet goed, waardoor een devicve eerder kan aankomen dan
				dat die vertrekt
